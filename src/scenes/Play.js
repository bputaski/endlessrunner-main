class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.background = this.add.tileSprite(0, 0, game.config.width, game.config.height, 'day').setOrigin(0, 0);
        ...
        this.MAX_JUMPS = 4; // change for double/triple/etc. jumps 🤾‍♀️
        ...
        // Adding enemy1
        this.enemy1 = new Enemy1(this, game.config.width, game.config.height-250, 'enemy1', 0).setOrigin(0, 0);
